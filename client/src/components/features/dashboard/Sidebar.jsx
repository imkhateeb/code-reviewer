  ...
  return (
    <div className="p-5 border-r h-full flex flex-col justify-between">
      <div className="flex flex-col gap-4">
        ...
        <Link
          to={"/dashboard"}
          onClick={() => setHovered("Dashboard")}
          className="w-full shrink-effect flex gap-2 border-[1px] border-gray-300 rounded-lg p-2 justify-between items-center cursor-pointer"
        >
      ...
      <div className="flex flex-col">
        ...
        <div
          ...
          className="flex gap-1 shrink-effect items-center p-2.5 hover:bg-gray-100 cursor-pointer rounded-lg"
        >
